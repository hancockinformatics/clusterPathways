...
reactome_categories_MMU_L1_L2 <- enr_pathway_high_level %>%
  left_join(rename(all_pathways, "level_1" = description),
            by = c(level_1_id = "pathway_id")) %>%
  left_join(rename(all_pathways, "level_2" = description),
...
usethis::use_data(reactome_categories_MMU_L1_L2, overwrite = TRUE)
